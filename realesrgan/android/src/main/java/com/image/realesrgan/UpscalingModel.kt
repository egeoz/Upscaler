...
enum class UpscalingModel(
    ...
    X4_PLUS(1, R.string.x4_plus_model_label, "realesrgan-x4plus.mnn", 4, "_x16"),
    X4_PLUS_ANIME(
        2,
        R.string.x4_plus_anime_model_label,
        "realesrgan-x4plus-anime.mnn",
        4,
        "_x16_drawing"
    );
